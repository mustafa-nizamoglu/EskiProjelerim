...
//                            + kitap.yazar + ", Fiyatı: " + kitap.getKitapFiyatı());
//                    kitapVarMi=true;
//
//                }
//
...
//
//                if (kitap1.getKitapFiyatı() == fiyat) {
//
//                    System.out.println(
//                            "Kitap No: " + kitap1.kitapNo +
//                                    ", Kitap Adı: " + kitap1.kitapAdı
//                                    + ", Yazar Adı: " + kitap1.yazar +
//                                    ", Fiyatı: " + kitap1.getKitapFiyatı());
//
//                    gecerliMi = true;
//                } else if (kitap1.yazar.equalsIgnoreCase(yazar1) || kitap1.kitapAdı.equalsIgnoreCase(kitap)) {
//
//                    System.out.println(
//                            "Kitap No: " + kitap1.kitapNo +
//                                    ", Kitap Adı: " + kitap1.kitapAdı
...
//    }
//
//    private static class EklenenKitaplar {
//        public int kitapNo;
//        private String kitapFiyatı;
//        public String yazar;
//        public String kitapAdı;
//
//        public EklenenKitaplar(int count, String kitapAd, String yazarAd, int fiyat) {
//
//        }
//
//        public String getKitapFiyatı() {
//            return kitapFiyatı;
//        }
//
//        public void setKitapFiyatı(String kitapFiyatı) {
