...
public class C01_HashSet {
    ...
    public static void main(String[] args) {
        ...
        HashSet<String>hs1=new HashSet<>(Arrays.asList("Ercan","Yakup","Adem","Rukiye","Nur"));//eleman ataması yapılan bir hasset
        //set print etme
        ...
        System.out.println("hs2 = " +hs1.remove("asıktır"));
        System.out.println("hs2 = " +hs1.remove("Asıktır"));
        System.out.println("hs1 = " + hs1);

        System.out.println("hs1 = " + hs1.removeAll(hs2));
        System.out.println("hs1 = " + hs1);

        System.out.println("hs1 = " + hs1.size());

        System.out.println("hs1 = " + hs1.isEmpty());
        ...
        System.out.println("hs2 = " + hs2.hashCode());//
